...
Route::delete('/forums{forum_id}', 'ForumController@delete')->middleware('auth')->name('forums.delete');
...
Route::delete('/responses{response_id}', 'ResponseController@delete')->middleware('auth')->name('responses.delete');
